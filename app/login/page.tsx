  ...
  return (
    <div className="sseuksak-shell relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-canvas pointer-events-none">
        <div className="absolute -top-20 -right-20 w-[300px] h-[300px] rounded-full" style={{ background: 'radial-gradient(circle, rgba(14,165,233,0.14) 0%, transparent 70%)' }} />
        <div className="absolute bottom-0 -left-16 w-[260px] h-[260px] rounded-full" style={{ background: 'radial-gradient(circle, rgba(255,184,0,0.12) 0%, transparent 70%)' }} />
      </div>

      {/* Back button */}
      <div className="relative z-10 flex items-center h-14 px-3 safe-top">
        <button
      ...
      <div className="relative z-10 flex-1 flex flex-col px-6 pt-2 pb-24">
          {mode === 'choose' && (
            <div className="flex flex-col flex-1">
              ...
              <p className="t-body text-text-muted mb-8 leading-relaxed">
                소셜 계정이나 이메일로 시작해보세요.
              </p>
              ...
              <div className="flex flex-col gap-3">
                  ...
                  {loading ? (
                    ...
                    <>
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path d="M9 1C4.58 1 1 3.83 1 7.32c0 2.26 1.52 4.24 3.8 5.36L3.8 16.5c-.06.22.17.4.37.28l4.25-2.8c.19.02.38.04.58.04 4.42 0 8-2.83 8-6.7C17 3.83 13.42 1 9 1z" fill="#191919" />
                      </svg>
                      카카오로 3초 만에 시작하기
                    </>
                  )}
                ...
                <button
                  ...
                  disabled={loading}
                  className="mt-2 text-sm font-bold text-text-muted hover:text-ink transition underline underline-offset-4 text-center"
                >
                  아직 계정이 없으신가요? 회원가입
                </button>
              </div>
              ...
              <form onSubmit={handleEmailAuth} className="flex flex-col gap-4">
                <div>
                  ...
                  <div className="relative">
                    <Mail size={17} className="absolute left-4 top-1/2 -translate-y-1/2 text-text-faint pointer-events-none" />
                    <input
                      type="email"
                      required
                      value={email}
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock size={17} className="absolute left-4 top-1/2 -translate-y-1/2 text-text-faint pointer-events-none" />
                    <input
                      type="password"
                      required
                      minLength={6}
                ...
                <button type="submit" disabled={loading} className="btn btn-primary w-full mt-1">
                  {loading ? <Loader2 size={20} className="animate-spin" /> : mode === 'email' ? '로그인' : '회원가입'}
                </button>
              </form>
