  ...
  return (
    <div className="page-container bg-premium-v2">
      ...
      <style jsx>{`
        ...
        .earnings-bento { display: flex; gap: 12px; margin-bottom: 32px; }
        .bento-item { flex: 1; background: #FFFFFF; border-radius: 24px; padding: 24px; box-shadow: var(--shadow-sm); display: flex; flex-direction: column; justify-content: center; }
        .bento-item.pending { background: var(--color-primary); color: #FFFFFF; }
        .bento-item .label { font-size: 12px; color: var(--color-text-tertiary); font-weight: 700; margin-bottom: 6px; }
        .pending .label { color: rgba(255,255,255,0.7); }
        .bento-item .value { font-size: 20px; font-weight: 900; }
        .pending .note { font-size: 10px; margin-top: 8px; color: rgba(255,255,255,0.6); font-weight: 600; }
        .section-header { margin-bottom: 16px; }
        .section-title { font-size: 18px; font-weight: 800; }
        .payment-stack { display: flex; flex-direction: column; gap: 12px; }
        .payment-card-premium { padding: 24px; }
        .card-top { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 16px; }
        .space-name { font-size: 16px; font-weight: 700; color: var(--color-text-primary); margin-bottom: 2px; }
        .date { font-size: 12px; font-weight: 600; }
        .payout-info { text-align: right; display: flex; flex-direction: column; align-items: flex-end; gap: 6px; }
        .payout-value { font-size: 17px; font-weight: 900; }
        .payout-value.released { color: var(--color-primary); }
        .payout-value.held { color: var(--color-text-secondary); }
        .status-tag { font-size: 10px; font-weight: 800; padding: 2px 8px; border-radius: 6px; }
        ...
        .card-details { padding-top: 12px; border-top: 1px solid var(--color-border-light); }
        .tax-row { display: flex; justify-content: space-between; font-size: 12px; color: var(--color-text-tertiary); margin-bottom: 2px; }
        .gross-total { font-size: 11px; text-align: right; color: var(--color-text-disabled); }
