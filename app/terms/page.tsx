        ...
        <article className="prose prose-sm max-w-none text-ink-soft">
          ...
          <Section title="제6조 (결제 및 정산)">
            <ol className="list-decimal pl-5">
              ...
              <li>작업 승인 후, 공간파트너 결제 금액에서 플랫폼 이용료(스타터 15%, 등급별 차등 최저 12%)를 공제한 금액이 클린파트너에게 정산됩니다. 클린파트너는 별도 수수료를 부담하지 않으며, 프리랜서의 경우 소득세 3.3%가 원천징수됩니다. 처음 2건은 이용료 10% 특별 프로모션이 적용됩니다.</li>
              <li>정산은 작업 승인 후 3일 이내(골드·마스터 등급은 익일)를 원칙으로 하며, 세무 관련 사항은 관계 법령에 따릅니다.</li>
            </ol>
          </Section>
