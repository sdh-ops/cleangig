...
const FAQS = [
  ...
  {
    q: '[클린파트너] 얼마나 벌 수 있나요?',
    a: '건당 1~4만원(기본 청소 기준)이며, 난이도·면적·심야·긴급 할증 시 더 올라갑니다. 작업 완료 후 3일 이내 정산되며, 티어가 올라갈수록 수수료 할인과 우선 매칭 혜택이 커집니다.',
  },
  {
    q: '[클린파트너] 근로자로 분류되나요?',
  ...
  },
  {
    ...
    a: '청소 요청 시 안전 결제가 이뤄지며, 작업 승인 후 클린파트너에게 정산됩니다. 24시간 전 취소 시 전액 환불, 3시간 전 30% 수수료, 1시간 전 50% 수수료, 1시간 이내 환불 불가입니다.',
  },
  {
    q: '품질은 어떻게 보증되나요?',
    a: '필수 체크리스트는 사진으로 남기고, AI가 사진을 자동으로 확인합니다. 리뷰·매너 온도·티어 시스템으로 신뢰를 관리해요. 문제 발생 시 분쟁 신고 기능을 통해 24시간 내 조정이 이뤄집니다.',
  },
  {
    q: '수수료는 어떻게 되나요?',
    a: '클린파트너는 별도 수수료를 떼지 않아요 — 화면에 표시된 예상 수령액이 곧 받는 금액입니다(프리랜서는 소득세 3.3%만 원천징수). 플랫폼은 공간파트너 결제 금액에서 이용료(스타터 15% → 마스터 12%)만 가져가며, 등급이 오를수록 같은 작업도 정산액이 늘어나요. 처음 2건은 이용료 10% 프로모션이 적용됩니다.',
  },
]
