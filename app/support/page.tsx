...
const FAQS = [
  ...
  {
    q: '[클린파트너] 얼마나 벌 수 있나요?',
    a: '건당 평균 3~5만원(기본 청소 기준)이며, 심야·긴급 할증 시 더 올라갑니다. 주 1회 정산되며 티어가 올라갈수록 수수료 할인과 우선 매칭 혜택이 커집니다. 주말 파트타임 기준 월 40만원+ 가능해요.',
  },
  {
    q: '[클린파트너] 근로자로 분류되나요?',
  ...
  },
  {
    ...
    a: '요청 등록 후 평균 4분 내 근처 클린파트너와 매칭됩니다. 긴급 요청 기능을 이용하면 즉시 알림이 발송됩니다.',
  },
  {
