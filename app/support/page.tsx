...
const FAQS = [
  {
    q: '쓱싹은 어떤 서비스인가요?',
    a: '공간파트너와 클린파트너를 연결하는 양방향 청소 매칭 플랫폼입니다. 청소가 필요한 사람은 원클릭으로 요청하고, 부업으로 청소하고 싶은 사람은 원하는 시간·지역에서 일할 수 있어요.',
  },
  {
    q: '[클린파트너] 어떻게 일을 시작하나요?',
    a: '가입 후 역할을 "클린파트너"로 선택, 정산 계좌를 등록하면 바로 작업을 찾을 수 있어요. 본인 인증을 마치면 매칭 우선순위가 올라갑니다.',
  },
  {
    q: '[클린파트너] 얼마나 벌 수 있나요?',
  ...
  {
    q: '[클린파트너] 근로자로 분류되나요?',
    a: '아니요. 쓱싹은 중개 플랫폼이고, 클린파트너는 프리랜서/개인사업자로 독립적으로 일합니다. 일하는 시간·장소를 자유롭게 선택할 수 있어요.',
  },
  {
    q: '[공간파트너] 결제는 언제 이뤄지나요?',
    a: '청소 요청 시 결제가 이뤄지며, 에스크로로 안전하게 보관됩니다. 작업 승인 후 클린파트너에게 정산됩니다.',
  },
  {
    q: '[공간파트너] 취소하면 환불은?',
  ...
  {
    q: '플랫폼 수수료는 얼마인가요?',
    a: '거래 금액의 10~15%이며, 클린파트너 티어가 올라갈수록 수수료 할인이 적용됩니다.',
  },
]
